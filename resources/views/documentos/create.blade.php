...
<div class="row justify-content-center">
    <div class="col-md-10">
        ...
        <div class="card">
            <div class="card-header">
                <div class="float-start"><br>
                    <div  style="padding-left: 20px;" >
                        <h3 class="texto-guinda">Pre-registro de productores</h3><br>
                    </div>
                </div>
            ...
            <div class="card-body">
                <form action="{{ route('documentos.store') }}" id="nuevoDocumentoForm" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-3 row">
                        ...
                        <label for="productor" class="col-form-label text-md-end text-start control-label texto-guinda">
                            ...
                            <input type="text" class="form-control @error('productor') is-invalid @enderror"
                                    id="productor" name="productor" value="{{ old('productor') }}" 
                                ...
                                <div class="col text-start" style="padding-right: 60px;">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="col col-md-3">
                                            <input style="border-radius: 0px;" type="tel" class="form-control @error('lada') is-invalid @enderror" id="lada" name="lada" placeholder="443" pattern="[0-9]{3}" required>
                                                @if ($errors->has('lada'))
                                                    <span class="text-danger">{{ $errors->first('lada') }}</span>
                                                @endif
                                        </div>
                                        <input type="tel" class="form-control @error('telefono') is-invalid @enderror" id="telefono" name="telefono" placeholder="1234567" pattern="[0-9]{7}" required>
                ...
                -->    
                    ...
                    <div class="text-center">
                        <button title="Guardar registro" class="btn btn-primary"><em class="fas fa-save"></em> Guardar</button>
                    </div><br>
                </form>
            </div>
        </div>
    ...
    {!! JsValidator::formRequest('App\Http\Requests\StoreDocumentoRequest', '#nuevoDocumentoForm') !!}
@endsection